// Package errors provides shared error utilities for agent subpackages.
// Extracted from pkg/agent to break the import cycle between pkg/agent and pkg/agent/kube.
package errors
