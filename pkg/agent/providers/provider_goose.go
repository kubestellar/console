...
// GooseProvider implements the ai.Provider interface for Goose CLI by Block, Inc.
...
func (g *GooseProvider) Capabilities() ai.ProviderCapability {
...
func (g *GooseProvider) Chat(ctx context.Context, req *ai.ChatRequest) (*ai.ChatResponse, error) {
...
func (g *GooseProvider) StreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string)) (*ai.ChatResponse, error) {
	if g.cliPath == "" {
