...
// OpenRouterProvider implements ai.Provider for OpenRouter (https://openrouter.ai).
//
...
func openRouterResolveBaseURL() string {
	...
	if v := config.GetConfigManager().GetBaseURL(openRouterProviderKey); v != "" {
		return v
	}
...
func (o *OpenRouterProvider) IsAvailable() bool {
	...
	return config.GetConfigManager().IsKeyAvailable(openRouterProviderKey)
}

func (o *OpenRouterProvider) Capabilities() ai.ProviderCapability {
...
func (o *OpenRouterProvider) Chat(ctx context.Context, req *ai.ChatRequest) (*ai.ChatResponse, error) {
...
func (o *OpenRouterProvider) StreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string)) (*ai.ChatResponse, error) {
