...
// CopilotCLIProvider implements the ai.Provider and ai.StreamingProvider interfaces
...
func (c *CopilotCLIProvider) Capabilities() ai.ProviderCapability {
...
func (c *CopilotCLIProvider) Chat(ctx context.Context, req *ai.ChatRequest) (*ai.ChatResponse, error) {
...
func (c *CopilotCLIProvider) StreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string)) (*ai.ChatResponse, error) {
	return c.StreamChatWithProgress(ctx, req, onChunk, nil)
}

// StreamChatWithProgress implements ai.StreamingProvider for real-time streaming.
// On auth errors it attempts one automatic token refresh and retry (#11079).
func (c *CopilotCLIProvider) StreamChatWithProgress(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string), onProgress func(event ai.StreamEvent)) (*ai.ChatResponse, error) {
...
func buildCopilotCLIPrompt(req *ai.ChatRequest) string {
...
func (c *CopilotCLIProvider) doStreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string), onProgress func(event ai.StreamEvent)) (*ai.ChatResponse, error) {
	if c.cliPath == "" {
