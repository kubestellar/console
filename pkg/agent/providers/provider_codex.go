...
// CodexProvider implements the ai.Provider interface for OpenAI Codex CLI
...
func (c *CodexProvider) Capabilities() ai.ProviderCapability {
...
func (c *CodexProvider) Chat(ctx context.Context, req *ai.ChatRequest) (*ai.ChatResponse, error) {
...
func (c *CodexProvider) StreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string)) (*ai.ChatResponse, error) {
	if c.cliPath == "" {
