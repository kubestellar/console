...
func (a *AntigravityProvider) Capabilities() ai.ProviderCapability {
...
func (a *AntigravityProvider) Handshake(ctx context.Context) *ai.HandshakeResult {
...
func (a *AntigravityProvider) Chat(ctx context.Context, req *ai.ChatRequest) (*ai.ChatResponse, error) {
...
func (a *AntigravityProvider) StreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string)) (*ai.ChatResponse, error) {
