...
func (b *BobProvider) Capabilities() ai.ProviderCapability {
...
func (b *BobProvider) buildPromptWithHistory(req *ai.ChatRequest) string {
...
func (b *BobProvider) Chat(ctx context.Context, req *ai.ChatRequest) (*ai.ChatResponse, error) {
	if b.cliPath == "" {
...
func (b *BobProvider) StreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string)) (*ai.ChatResponse, error) {
