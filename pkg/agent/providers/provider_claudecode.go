...
func withToolAvailabilityContext(req *ai.ChatRequest, status ToolAvailabilityStatus) *ai.ChatRequest {
...
func (c *ClaudeCodeProvider) Capabilities() ai.ProviderCapability {
	return ai.CapabilityChat | ai.CapabilityToolExec
}
...
var ClaudeCodeSystemPrompt = claudeCodeSystemPromptBase + prompts.OSCommandHint()
...
func (c *ClaudeCodeProvider) buildPromptWithHistory(req *ai.ChatRequest) string {
...
func (c *ClaudeCodeProvider) Chat(ctx context.Context, req *ai.ChatRequest) (*ai.ChatResponse, error) {
...
// StreamChat streams responses via callback (implements ai.Provider interface)
func (c *ClaudeCodeProvider) StreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string)) (*ai.ChatResponse, error) {
...
func (c *ClaudeCodeProvider) StreamChatWithProgress(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string), onProgress func(event ai.StreamEvent)) (*ai.ChatResponse, error) {
	if c.cliPath == "" {
...
Provide a clear, concise analysis of what this output shows.`, lastToolOutput)
		...
		procutil.ConfigureProcessGroup(analysisCmd) // #9442: kill entire process tree on timeout
	...
	return &ai.ChatResponse{
		...
		Agent:   c.Name(),
		TokenUsage: &ai.ProviderTokenUsage{
