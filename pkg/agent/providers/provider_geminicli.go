...
// GeminiCLIProvider implements the ai.Provider interface for Google Gemini CLI
...
func (g *GeminiCLIProvider) Capabilities() ai.ProviderCapability {
...
func (g *GeminiCLIProvider) Chat(ctx context.Context, req *ai.ChatRequest) (*ai.ChatResponse, error) {
...
func (g *GeminiCLIProvider) StreamChat(ctx context.Context, req *ai.ChatRequest, onChunk func(chunk string)) (*ai.ChatResponse, error) {
	if g.cliPath == "" {
