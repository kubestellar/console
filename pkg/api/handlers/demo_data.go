...
func GetDemoPodNetworkStats() []htypes.PodNetworkStats {
	...
	return []htypes.PodNetworkStats{
		{
			PodName:   "tenant-1-vm-virt-launcher-abc12",
			Namespace: "tenant-1-ns1",
			Component: "kubevirt",
			Interfaces: []htypes.InterfaceStats{
				{Name: "eth0", RxBytes: kvEth0RxRate * htypes.NetworkStatsPollIntervalSec, TxBytes: kvEth0TxRate * htypes.NetworkStatsPollIntervalSec, RxBytesPerSec: kvEth0RxRate, TxBytesPerSec: kvEth0TxRate},
				{Name: "eth1", RxBytes: kvEth1RxRate * htypes.NetworkStatsPollIntervalSec, TxBytes: kvEth1TxRate * htypes.NetworkStatsPollIntervalSec, RxBytesPerSec: kvEth1RxRate, TxBytesPerSec: kvEth1TxRate},
			},
		},
		{
			...
			Component: "k3s",
			Interfaces: []htypes.InterfaceStats{
				{Name: "eth0", RxBytes: k3sEth0RxRate * htypes.NetworkStatsPollIntervalSec, TxBytes: k3sEth0TxRate * htypes.NetworkStatsPollIntervalSec, RxBytesPerSec: k3sEth0RxRate, TxBytesPerSec: k3sEth0TxRate},
				{Name: "eth1", RxBytes: k3sEth1RxRate * htypes.NetworkStatsPollIntervalSec, TxBytes: k3sEth1TxRate * htypes.NetworkStatsPollIntervalSec, RxBytesPerSec: k3sEth1RxRate, TxBytesPerSec: k3sEth1TxRate},
			},
		},
	}
}
