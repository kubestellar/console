...
// Accepts *k8sclient.MultiClusterClient (or any mcsClient implementation).
func NewMCSHandlers(k8sClient *k8sclient.MultiClusterClient, hub *transport.Hub) *MCSHandlers {
	return &MCSHandlers{
		k8sClient: k8sClient,
		hub:       hub,
	}
