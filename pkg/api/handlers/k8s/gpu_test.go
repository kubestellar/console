...
func (c *gpuProvisioningTestClient) CreateOrUpdateResourceQuota(_ context.Context, contextName string, spec k8sclient.ResourceQuotaSpec) (*k8sclient.ResourceQuota, error) {
	...
	return &k8sclient.ResourceQuota{Name: spec.Name, Namespace: spec.Namespace}, nil
}
