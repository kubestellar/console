...
// crdClient defines the narrow subset of k8sclient.MultiClusterClient used by CRDHandlers.
...
// Accepts *k8sclient.MultiClusterClient (or any crdClient implementation).
func NewCRDHandlers(k8sClient *k8sclient.MultiClusterClient) *CRDHandlers {
	h := &CRDHandlers{}
	if k8sClient != nil {
