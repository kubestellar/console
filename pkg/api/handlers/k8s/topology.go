...
// topologyClient is the narrow interface TopologyHandlers requires from the
...
func NewTopologyHandlers(k8sClient *k8sclient.MultiClusterClient, hub *transport.Hub) *TopologyHandlers {
