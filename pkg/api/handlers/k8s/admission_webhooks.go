...
// webhookClient defines the narrow subset of k8sclient.MultiClusterClient used by WebhookHandlers.
...
type WebhookHandlers struct {
	k8sClient webhookClient
}

// NewWebhookHandlers creates a new webhook handlers instance.
// Accepts *k8sclient.MultiClusterClient (or any webhookClient implementation).
func NewWebhookHandlers(k8sClient *k8sclient.MultiClusterClient) *WebhookHandlers {
	h := &WebhookHandlers{}
	if k8sClient != nil {
