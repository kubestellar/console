...
<<<<<<<< HEAD:pkg/api/handlers/nightly_e2e_github.go
...
>>>>>>>> 4ad6bc509 (🌱 Refactor: Split nightly_e2e.go and console_persistence.go into focused files):pkg/api/handlers/nightly_e2e_handler.go
