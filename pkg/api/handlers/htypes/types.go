// Package htypes provides shared types used by both the handlers and
// handlers/mcp packages, breaking what would otherwise be an import cycle.
package htypes
...
// ClusterError represents a per-cluster failure in a multi-cluster request.
