...
// HandleLegacyK8sError preserves the legacy helper signature and response
// format used by older callers and tests while newer handlers migrate to
// HandleK8sError.
func HandleLegacyK8sError(c *fiber.Ctx, err error) error {
	if err == nil {
		return nil
	}
