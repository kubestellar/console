...
func GetDemoPodNetworkStats() []handlers.PodNetworkStats {
	...
	return []handlers.PodNetworkStats{
		{
			PodName:   "tenant-1-vm-virt-launcher-abc12",
			Namespace: "tenant-1-ns1",
			Component: "kubevirt",
			Interfaces: []handlers.InterfaceStats{
				{Name: "eth0", RxBytes: kvEth0RxRate * handlers.NetworkStatsPollIntervalSec, TxBytes: kvEth0TxRate * handlers.NetworkStatsPollIntervalSec, RxBytesPerSec: kvEth0RxRate, TxBytesPerSec: kvEth0TxRate},
				{Name: "eth1", RxBytes: kvEth1RxRate * handlers.NetworkStatsPollIntervalSec, TxBytes: kvEth1TxRate * handlers.NetworkStatsPollIntervalSec, RxBytesPerSec: kvEth1RxRate, TxBytesPerSec: kvEth1TxRate},
			},
		},
		{
			...
			Component: "k3s",
			Interfaces: []handlers.InterfaceStats{
				{Name: "eth0", RxBytes: k3sEth0RxRate * handlers.NetworkStatsPollIntervalSec, TxBytes: k3sEth0TxRate * handlers.NetworkStatsPollIntervalSec, RxBytesPerSec: k3sEth0RxRate, TxBytesPerSec: k3sEth0TxRate},
				{Name: "eth1", RxBytes: k3sEth1RxRate * handlers.NetworkStatsPollIntervalSec, TxBytes: k3sEth1TxRate * handlers.NetworkStatsPollIntervalSec, RxBytesPerSec: k3sEth1RxRate, TxBytesPerSec: k3sEth1TxRate},
			},
		},
	}
}
