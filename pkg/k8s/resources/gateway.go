...
// class as #6476).
func (m *k8s.MultiClusterClient) ListGateways(ctx context.Context) (*v1alpha1.GatewayList, error) {
...
func (m *k8s.MultiClusterClient) ListGatewaysForCluster(ctx context.Context, contextName, namespace string) ([]v1alpha1.Gateway, error) {
...
func (m *k8s.MultiClusterClient) parseGatewaysFromList(list interface{}, contextName string) ([]v1alpha1.Gateway, error) {
	gateways := make([]v1alpha1.Gateway, 0)
...
func (m *k8s.MultiClusterClient) ListHTTPRoutes(ctx context.Context) (*v1alpha1.HTTPRouteList, error) {
	dedupClusters, err := m.DeduplicatedClusters(ctx)
	if err != nil {
		return nil, fmt.Errorf("failed to list clusters: %w", err)
	}
...
func (m *k8s.MultiClusterClient) ListHTTPRoutesForCluster(ctx context.Context, contextName, namespace string) ([]v1alpha1.HTTPRoute, error) {
	dynamicClient, err := m.GetDynamicClient(contextName)
	if err != nil {
		return nil, err
	}
...
func (m *k8s.MultiClusterClient) parseHTTPRoutesFromList(list interface{}, contextName string) ([]v1alpha1.HTTPRoute, error) {
	routes := make([]v1alpha1.HTTPRoute, 0)
...
func (m *k8s.MultiClusterClient) IsGatewayAPIAvailable(ctx context.Context, contextName string) bool {
	dynamicClient, err := m.GetDynamicClient(contextName)
	if err != nil {
		return false
	}
