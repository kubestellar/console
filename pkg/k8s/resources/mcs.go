...
func (m *k8s.MultiClusterClient) ListServiceExports(ctx context.Context) (*v1alpha1.ServiceExportList, error) {
...
func (m *k8s.MultiClusterClient) ListServiceExportsForCluster(ctx context.Context, contextName, namespace string) ([]v1alpha1.ServiceExport, error) {
...
func (m *k8s.MultiClusterClient) parseServiceExportsFromList(list interface{}, contextName string) ([]v1alpha1.ServiceExport, error) {
	exports := make([]v1alpha1.ServiceExport, 0)
...
func (m *k8s.MultiClusterClient) ListServiceImports(ctx context.Context) (*v1alpha1.ServiceImportList, error) {
	dedupClusters, err := m.DeduplicatedClusters(ctx)
	if err != nil {
		return nil, fmt.Errorf("failed to list clusters: %w", err)
	}
...
func (m *k8s.MultiClusterClient) ListServiceImportsForCluster(ctx context.Context, contextName, namespace string) ([]v1alpha1.ServiceImport, error) {
	dynamicClient, err := m.GetDynamicClient(contextName)
	if err != nil {
		return nil, err
	}
...
func (m *k8s.MultiClusterClient) parseServiceImportsFromList(list interface{}, contextName string) ([]v1alpha1.ServiceImport, error) {
	imports := make([]v1alpha1.ServiceImport, 0)
...
func (m *k8s.MultiClusterClient) CreateServiceExport(ctx context.Context, contextName, namespace, serviceName string) error {
	dynamicClient, err := m.GetDynamicClient(contextName)
	if err != nil {
		return err
	}
...
func (m *k8s.MultiClusterClient) DeleteServiceExport(ctx context.Context, contextName, namespace, name string) error {
	dynamicClient, err := m.GetDynamicClient(contextName)
	if err != nil {
		return err
	}
...
func (m *k8s.MultiClusterClient) IsMCSAvailable(ctx context.Context, contextName string) bool {
	dynamicClient, err := m.GetDynamicClient(contextName)
	if err != nil {
		return false
	}
