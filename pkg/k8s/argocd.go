...
func (m *client.MultiClusterClient) ListArgoApplications(ctx context.Context) (*v1alpha1.ArgoApplicationList, error) {
...
func (m *client.MultiClusterClient) ListArgoApplicationsForCluster(ctx context.Context, contextName, namespace string) ([]v1alpha1.ArgoApplication, error) {
...
func (m *client.MultiClusterClient) parseArgoApplicationsFromList(list interface{}, contextName string) ([]v1alpha1.ArgoApplication, error) {
	apps := make([]v1alpha1.ArgoApplication, 0)
...
// If ArgoCD CRDs are not installed on a cluster, that cluster is silently skipped.
func (m *client.MultiClusterClient) ListArgoApplicationSets(ctx context.Context) (*v1alpha1.ArgoApplicationSetList, error) {
	// Use DeduplicatedClusters so newly-added kubeconfig contexts (hot reload)
	// are picked up immediately, instead of snapshotting m.clients which only
	// contains contexts whose clients have already been lazily created (#6476).
	dedupClusters, err := m.DeduplicatedClusters(ctx)
...
// Returns an empty list (not an error) if ArgoCD CRDs are not installed.
func (m *client.MultiClusterClient) ListArgoApplicationSetsForCluster(ctx context.Context, contextName string) ([]v1alpha1.ArgoApplicationSet, error) {
	dynamicClient, err := m.GetDynamicClient(contextName)
	if err != nil {
		return nil, err
	}
...
func (m *client.MultiClusterClient) parseArgoApplicationSetsFromList(list interface{}, contextName string) []v1alpha1.ArgoApplicationSet {
	appSets := make([]v1alpha1.ArgoApplicationSet, 0)
