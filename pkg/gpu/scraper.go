...
func ScrapeDCGMByNamespace(ctx context.Context, config *rest.Config, scrape DCGMScrapeConfig, getClient func(*rest.Config) (*http.Client, error)) (map[string]*DCGMNamespaceMetrics, error) {
	if config == nil {
