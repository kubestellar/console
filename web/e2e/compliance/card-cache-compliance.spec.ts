 ...
 * Increased to 10000ms (20× local) to account for nightly CI runner variability
 * (#13547, #13789, #14815, #14979). With 150+ cards evaluated in a single Playwright
 * context, shared CI infrastructure can spike beyond 8000ms during peak load.
 */
const WARM_TTC_THRESHOLD_MS = process.env.CI ? 10_000 : 500
