/**
 * useAgenticDetectionRuns — fetch detection run data from the active
 * GitHub "[aw] Detection Runs" tracking issue.
 *
  ...
  runs: [
    {
      ...
      commentUrl: 'https://github.com/kubestellar/console/issues/16283#issuecomment-12345',
    },
    {
      conclusion: 'warning',
      ...
      commentUrl: 'https://github.com/kubestellar/console/issues/16283#issuecomment-12344',
    },
    {
      conclusion: 'failure',
      ...
      commentUrl: 'https://github.com/kubestellar/console/issues/16283#issuecomment-12343',
    },
  ],
  issueUrl: 'https://github.com/kubestellar/console/issues/16283',
  totalCount: 3,
  source: 'demo',
  cachedAt: new Date().toISOString(),
  isDemoData: true,
