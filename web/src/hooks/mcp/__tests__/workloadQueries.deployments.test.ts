/**
 * Tests for hooks/mcp/workloadQueries.ts — deployment, job, and pod log hooks
 *
 * Covers: useDeploymentIssues, useDeployments, useJobs, useHPAs, useReplicaSets,
 * useStatefulSets, useDaemonSets, useCronJobs, usePodLogs.
 */
