/**
 * Tests for hooks/mcp/workloadQueries.ts — demo data helpers and localStorage cache
 *
 * Covers: getDemoPods, getDemoPodIssues, getDemoDeploymentIssues, getDemoDeployments,
 * getDemoAllPods, loadPodsCacheFromStorage, savePodsCacheToStorage.
 */
