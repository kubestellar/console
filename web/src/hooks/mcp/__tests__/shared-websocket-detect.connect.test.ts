/**
 * Tests for hooks/mcp/shared — WebSocket connection and cluster fetch
 *
 * Covers: connectSharedWebSocket, updateSingleClusterInCache (distribution),
 * fullFetchClusters, refreshSingleCluster.
 */
