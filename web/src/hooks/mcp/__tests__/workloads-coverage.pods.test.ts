/**
 * Additional coverage tests for hooks/mcp/workloads.ts — usePods and
 * useAllPods edge cases (localStorage cache, SSE progressive updates,
 * error handling, silent refresh).
 *
