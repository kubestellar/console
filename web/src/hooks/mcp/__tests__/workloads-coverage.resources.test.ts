/**
 * Additional coverage tests for hooks/mcp/workloads.ts — useJobs, useHPAs,
 * useReplicaSets, useStatefulSets, useDaemonSets, useCronJobs, usePodLogs
 * uncovered branches, and subscribeWorkloadsCache notification behavior.
 *
