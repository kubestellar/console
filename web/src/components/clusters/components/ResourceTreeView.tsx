import { ChevronRight, ChevronDown, Box, Layers, Network, Activity, Briefcase, Lock, Settings, User, HardDrive } from 'lucide-react'import { StatusBadge } from '../../ui/StatusBadge'
