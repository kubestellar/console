...
import { Pencil, Globe, User, ShieldAlert, ChevronRight, Star, WifiOff, RefreshCw, ExternalLink, AlertCircle, KeyRound } from 'lucide-react'
...
export const FullClusterCard = memo(function FullClusterCard({
  cluster,
  gpuInfo,
  isConnected,
  permissionsLoading,
