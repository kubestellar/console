        ...
        <div className="space-y-5 text-sm">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <span className="font-mono text-foreground">L6 Autonomous</span>{' '}
          ...
          <section>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-3">
                ...
                <span className="text-xs text-muted-foreground">Rules mechanically enforced via hooks, CI, permission gates; metrics instrument the loop</span>
              </div>
              <div className="flex gap-3">
                ...
                <span className="text-xs text-muted-foreground">Metrics feed back into instructions; workflows are structured and environment-aware</span>
              </div>
              <div className="flex gap-3">
                ...
                <span className="text-xs text-muted-foreground">System <em>detects</em> problems and <em>proposes</em> fixes without human initiation — humans still approve</span>
              </div>
              <div className="flex gap-3">
                ...
                <span className="text-xs text-muted-foreground">System <em>acts</em> on what it finds — generates issues, merges PRs, rolls back failures; humans set policy and monitor</span>
              </div>
            </div>
            <p className="text-xs text-muted-foreground mt-2 italic">
              The key difference between L5 and L6: at L5 the system proposes and humans approve.
              At L6 the system acts and humans audit after the fact. L5 is &ldquo;review my PR&rdquo; — L6 is &ldquo;I merged it, here&apos;s the audit trail.&rdquo;
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-1 text-xs">
              <li>
                ...
                <span className="text-muted-foreground">— the 6-level model itself (L1–L6 + prerequisites)</span>
              </li>
              <li>
