...
import {
  Check, Loader2, Trash2, Download, HandHelping, Sparkles,
  Star, Coins, ExternalLink } from 'lucide-react'
...
import {
  TYPE_LABELS, DIFFICULTY_CONFIG, MATURITY_CONFIG,
  MAX_SKILLS, MAX_TAGS, MAX_THEME_COLORS, ISSUES_URL } from './marketplace.types'
