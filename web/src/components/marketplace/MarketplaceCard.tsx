...
import { Download, HandHelping, Sparkles, Check, Trash2, Loader2 } from 'lucide-react'
...
import { TYPE_LABELS, MATURITY_CONFIG, MAX_SKILLS, MAX_TAGS, MAX_THEME_COLORS, ISSUES_URL } from './marketplaceConstants'
