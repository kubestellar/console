...
import {
  ...
  Heart, HandHelping, ExternalLink, List, Grid3X3, SortAsc, SortDesc } from 'lucide-react'
...
import { CNCFProgressBanner } from './MarketplaceCNCFBanner'
import { MarketplaceCard, MarketplaceRow } from './MarketplaceItems'
import {
  VIEW_MODE_KEY, MARKETPLACE_DIV_STYLE_1, CONTRIBUTE_URL, ISSUES_URL,
  TYPE_LABELS, filterBtnClass,
  type ViewMode, type SortField, type SortOrder } from './marketplace.types'
