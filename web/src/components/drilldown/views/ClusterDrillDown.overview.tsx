/**
 * Overview panel for ClusterDrillDown — stat cards, GPU breakdown, issues, GPU nodes.
 * Extracted from ClusterDrillDown.tsx to keep files under 500 lines.
 */
...
import type { ClusterHealth, GPUNode, PodIssue, DeploymentIssue } from '../../../hooks/useMCP'

/** Lens type shared with the resource tree tab. */
export type TreeLens = 'all' | 'issues' | 'nodes' | 'workloads' | 'storage' | 'network'

interface ClusterOverviewProps {
  health: ClusterHealth | undefined
  navigateToResourceTree: (lens: TreeLens) => void
  ...
  drillToGPUNode: (cluster: string, node: string, data?: Record<string, unknown>) => void
}
