...
interface ClusterDrillDownEventsTabProps {
  clusterEvents: ClusterEvent[]
  eventsLoading: boolean
  onViewAll: () => void
}

export function ClusterDrillDownEventsTab({ clusterEvents, eventsLoading, onViewAll }: ClusterDrillDownEventsTabProps) {
  return (
    <div>
