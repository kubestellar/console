...
import { PanelSection, PanelDivider } from './PanelShell'
import { generateDefaultPhases, getDependencyNotes } from './deployModeHelpers'

interface DeployModeInfoPanelProps {
  mode: 'phased' | 'yolo'
  phases: DeployPhase[]
...
export function DeployModeInfoPanel({
  mode,
  phases,
  projects,
  onShowProject,
  installedProjects = new Set(),
}: DeployModeInfoPanelProps) {
  ...
  return (
    <>
      ...
      {mode === 'phased' && effectivePhases.length > 0 && (
        <PanelSection title="Launch Sequence" titleClassName="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-2">
      ...
      {mode === 'yolo' && projects.length > 0 && (
        <PanelSection title="All Launched Simultaneously" titleClassName="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-2">
      ...
      {depNotes.length > 0 && (
        <PanelSection title="Integration & Dependency Notes" titleClassName="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-2">
