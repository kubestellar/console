          ...
          <>
            {selected.map((name) => {
              ...
              return (
                ...
                >
                  <span className={cn('w-1.5 h-1.5 rounded-full', isHealthy ? 'bg-status-success' : 'bg-status-warning')} />
                  {name}
          ...
          {availableClusters.map((name) => {
            ...
            return (
              <button
                ...
                onClick={() => toggleCluster(name)}
              >
                <span className={cn('w-2 h-2 rounded-full shrink-0', isHealthy ? 'bg-status-success' : 'bg-status-warning')} />
