    ...
    try {
      ...
      const agentConnectionLog = (connectionEvents || []).length > 0
        ...
        : isInClusterMode
          ...
          : []
      const diagnostics: NonNullable<CreateFeatureRequestInput['diagnostics']> = {
        ...
        ...(agentHealth?.version != null && { agent_version: agentHealth.version }),
        ...(agentHealth?.commitSHA != null && { commit_sha: agentHealth.commitSHA }),
        ...(agentHealth?.buildTime != null && { build_time: agentHealth.buildTime }),
        ...(agentHealth?.goVersion != null && { go_version: agentHealth.goVersion }),
        ...(agentHealth?.os != null && { agent_os: agentHealth.os }),
        ...(agentHealth?.arch != null && { agent_arch: agentHealth.arch }),
        ...(agentHealth?.install_method != null && { install_method: agentHealth.install_method }),
        ...(agentHealth?.clusters != null && { clusters: agentHealth.clusters }),
        ...(activeBackend != null && { active_agent_backend: activeBackend }),
        ...(backendStatus != null && { backend_ws_status: backendStatus }),
        ...(agentStatus != null && { agent_connection_status: agentStatus }),
        ...(agentLastDataError != null && { agent_last_error: agentLastDataError }),
