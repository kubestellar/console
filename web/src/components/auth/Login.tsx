...
// Lazy load the heavy Three.js globe animation with retry + timeout.
// safeLazy handles stale chunks; the Suspense fallback covers load time.
// If all retries fail, the error boundary renders nothing — the globe is cosmetic.
