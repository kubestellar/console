...
// Apache 2.0 license text in the repository; opens in a new tab.
const APACHE_LICENSE_URL = 'https://github.com/kubestellar/console/blob/main/LICENSE'
