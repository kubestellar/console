...
export function AuthCallback() {
  ...
  useEffect(() => {
    ...
    // Capture the one-shot credential passed via the OAuth callback
    // fragment, strip the fragment immediately, then stash the value in
    // session storage for follow-up requests.
