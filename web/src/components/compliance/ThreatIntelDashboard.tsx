            ...
            <tbody>
              {feeds.map(feed => (
                <tr key={feed.id} className="border-b border-gray-700/50 hover:bg-gray-700/30">
                  ...
                  <td className="p-3"><span className="px-2 py-0.5 rounded bg-gray-700 text-gray-400 text-xs">{feed.category}</span></td>
                  <td className="p-3">
            ...
            <tbody>
              {iocs.map(ioc => (
                <tr key={ioc.id} className="border-b border-gray-700/50 hover:bg-gray-700/30">
                  <td className="p-3"><span className="px-2 py-0.5 rounded bg-gray-700 text-gray-400 text-xs uppercase">{ioc.ioc_type}</span></td>
