...
import { Satellite, Orbit, ChevronDown, ChevronUp, Loader2 } from 'lucide-react'
...
export function StandaloneOrbitDialog({ onClose, prefill }: StandaloneOrbitDialogProps) {
  ...
  return (
    <>
    <BaseModal isOpen onClose={onClose} size="md" closeOnBackdrop={false}>
      <BaseModal.Header
        title={t('orbit.standaloneTitle')}
        icon={Satellite}
        onClose={onClose}
      />

      <BaseModal.Content noPadding className="px-5 py-4 space-y-4">
