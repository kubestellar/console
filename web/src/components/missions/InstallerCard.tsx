...
function ProjectLogo({ cncfProject, iconPath, size }: {
  ...
  const backdropCls = size === 'lg'
    ? 'w-12 h-12 rounded-xl bg-white/90 dark:bg-gray-900/90 shadow-xs flex items-center justify-center'
    : 'w-6 h-6 rounded bg-white/90 dark:bg-gray-900/90 shadow-xs flex items-center justify-center'
  return (
