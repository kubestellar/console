// Cloud provider SVG icon components.
// Extracted from CloudProviderIcon.tsx so the public helper API (provider
// detection, labels, colors, console URLs) stays readable in one file.
import React from 'react'

// AWS EKS icon - blue hexagon with K
export const AWSIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
...
export const GCPIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
...
export const AzureIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
...
export const OpenShiftIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
...
export const OCIIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
...
export const AlibabaIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
...
export const DigitalOceanIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
...
export const RancherIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
...
export const CoreWeaveIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    <defs>
...
export const KindIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <img
    src="/kind-logo.png"
    alt="Kind logo"
    width={size}
...
export const MinikubeIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    {/* Outer hexagon outline */}
    <polygon
...
export const K3sIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
...
export const KubernetesIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
