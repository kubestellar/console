...
import { buildCardsFromSuggestions } from './DashboardCardState'
import { workloadCollisionDetection } from './DashboardLayoutState'
...
export function useDashboardState() {
  ...
  const collisionDetection = workloadCollisionDetection
  ...
  const handleAddCards = useCallback(async (suggestions: Array<{
    ...
    const newCards: Card[] = buildCardsFromSuggestions(suggestions, mapVisualizationToCardType, getDefaultCardSize)
