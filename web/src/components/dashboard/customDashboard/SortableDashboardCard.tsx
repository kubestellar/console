...
export function SortableDashboardCard({ card, onConfigure, onRemove, onWidthChange, onHeightChange, isDragging, isRefreshing, onRefresh, lastUpdated, onInsertBefore: _onInsertBefore, onInsertAfter }: SortableCardProps) {
  ...
  useEffect(() => {
    ...
    const handler = (event: MediaQueryListEvent) => setIsNarrowRange(event.matches)
