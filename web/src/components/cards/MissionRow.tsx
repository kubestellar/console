...
import { AlertTriangle, ChevronDown, ChevronRight, Orbit, Package, Terminal } from 'lucide-react'
...
import { getElapsed } from './Missions.utils'
import type { MissionRowProps } from './Missions.types'
    ...
    <div className={cn(
      ...
      >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <MissionStatusBadge label={config.label} color={config.color} bg={config.bg} />
        </div>
      </div>
