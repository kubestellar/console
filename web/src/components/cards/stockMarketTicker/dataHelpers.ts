...
import type { StockData, StockSearchResult, YahooQuoteResponse, YahooSearchQuote } from './types'

// CORS proxy to bypass browser restrictions for Yahoo Finance API
const CORS_PROXY = 'https://corsproxy.io/?'

// Common stock symbols database for fallback search
export const COMMON_STOCKS: StockSearchResult[] = [
...
// Market status
export function getMarketStatus(t: TFunction<readonly ['cards', 'common']>): { isOpen: boolean; statusText: string } {
  const now = new Date()
