...
import {
  Cpu, TrendingUp, TrendingDown, Minus, RefreshCw,
} from 'lucide-react'
...
import { GPUInventoryHistoryToolbar } from './GPUInventoryHistoryToolbar'
import { GPUInventoryHistoryChartPanel } from './GPUInventoryHistoryChartPanel'
import { GPUInventoryHistoryTable } from './GPUInventoryHistoryTable'
  ...
  return (
    <div className="h-full w-full min-w-0 flex flex-col content-loaded">
      <GPUInventoryHistoryToolbar
        ...
        setShowNodeDropdown={setShowNodeDropdown}
      ...
      <div className="flex-1 min-w-0 min-h-[160px]">
        {viewMode === 'chart' ? (
          <GPUInventoryHistoryChartPanel
            availableGPUTypesLength={availableGPUTypes.length}
            selectedGPUType={selectedGPUType}
            chartMode={chartMode}
