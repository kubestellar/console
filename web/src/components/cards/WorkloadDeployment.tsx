      ...
      {isSelected && !isDragging && (
        <div className="mt-3 pt-3 ml-10 border-t border-gray-200 dark:border-gray-600 space-y-2">
          ...
          <div className="flex gap-2 mt-2">
            <button className="flex items-center gap-1 text-xs px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded transition-colors min-h-11">
              <ArrowUpRight className="h-3 w-3" />
              Scale
            </button>
            <button className="flex items-center gap-1 text-xs px-3 py-2 bg-green-500 hover:bg-green-600 text-white rounded transition-colors min-h-11">
