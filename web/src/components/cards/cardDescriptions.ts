// Card description registry — pure data, no runtime deps.
...
export const CARD_DESCRIPTIONS: Record<string, string> = {
  ...
  kagenti_lifecycle_manager: 'Unified lifecycle view of Kagenti agents and builds with activity timeline.',
  ...
  kagent_lifecycle_state: 'Visual lifecycle state machine showing agent transitions (Pending, Accepted, Ready, Failed).',
