...
export const CardActionMenu = memo(function CardActionMenu({
  ...
  const { isOpen: showMenu, open: openMenu, close: closeMenu, setIsOpen: setShowMenu } = useModalState()
  const { isOpen: showResizeMenu, open: openResizeMenu, close: closeResizeMenu, setIsOpen: setShowResizeMenu } = useModalState()
  const { isOpen: showHeightMenu, open: openHeightMenu, close: closeHeightMenu, setIsOpen: setShowHeightMenu } = useModalState()
