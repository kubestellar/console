...
const WIDGET_MIN_REFRESH_INTERVAL_MS = 30_000
...
export const WIDGET_CARDS: Record<string, WidgetCardDefinition> = {
  cluster_health: {
    ...
    supportsTheme: true,
    minRefreshInterval: WIDGET_MIN_REFRESH_INTERVAL_MS,
  ...
  console_ai_offline_detection: {
    ...
    apiEndpoints: ['/api/mcp/nodes', '/api/mcp/gpu-nodes'],
    supportsTheme: true,
    minRefreshInterval: WIDGET_MIN_REFRESH_INTERVAL_MS,
  ...
  operator_status: {
    ...
    apiEndpoints: ['/api/gitops/operators'],
    supportsTheme: true,
    minRefreshInterval: 60000,
    defaultSize: { width: 250, height: 180 },
    category: 'workload',
  ...
  helm_releases: {
    ...
    apiEndpoints: ['/api/gitops/helm-releases'],
    supportsTheme: true,
    minRefreshInterval: 60000,
    defaultSize: { width: 250, height: 180 },
    category: 'workload',
