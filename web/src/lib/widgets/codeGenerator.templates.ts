...
import {
  getClusterCardRender,
  getDeploymentCardRender,
  getObservabilityCardRender,
  getPodCardRender,
  getResourceCardRender,
  getSecurityCardRender,
} from './templates'
import type { TemplateParts } from './templates'
...
export function generateCardRenderFunction(cardType: string, displayName?: string): string {
  ...
  const safeCard = card ?? { displayName: title }
  ...
  const categoryRender =
    getClusterCardRender(cardType, safeCard, templateParts)
    ?? getPodCardRender(cardType, safeCard, templateParts)
    ?? getDeploymentCardRender(cardType, safeCard, templateParts)
    ?? getResourceCardRender(cardType, safeCard, templateParts)
    ?? getSecurityCardRender(cardType, safeCard, templateParts)
    ?? getObservabilityCardRender(cardType, safeCard, templateParts)
