...
import { generateClusterCardRender } from './templates.cluster'
import { generatePodsCardRender } from './templates.pods'
import { generateEventsCardRender } from './templates.events'
import { generateStorageCardRender } from './templates.storage'
import { generateOperatorsCardRender } from './templates.operators'
import { generateGithubCardRender } from './templates.github'
import { generateConsoleAICardRender } from './templates.consoleai'
...
export function generateCardRenderFunction(cardType: string, displayName?: string): string {
  ...
  let result = generateClusterCardRender(cardType, card, title)
  if (result) return result

  result = generatePodsCardRender(cardType, card, title)
  if (result) return result

  result = generateEventsCardRender(cardType, card, title)
  if (result) return result

  result = generateStorageCardRender(cardType, card, title)
  if (result) return result

  result = generateOperatorsCardRender(cardType, card, title)
  if (result) return result

  result = generateGithubCardRender(cardType, card, title)
  if (result) return result

  result = generateConsoleAICardRender(cardType, card, title)
  if (result) return result
