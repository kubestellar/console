...
/**
 * Shared test factories and helpers for worker.module test suites.
 *
 * Exports types, mock db factory, handler functions, and processMessage
 * so the split test files can import them without duplicating setup.
 */
