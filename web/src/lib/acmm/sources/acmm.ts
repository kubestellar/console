...
const CRITERIA: Criterion[] = [
  ...
  },
  {
    ...
    details: 'A coverage gate blocks merging when test coverage drops below a threshold. An AI mission will add a GitHub Actions workflow that runs your test suite with coverage reporting and fails the PR check if coverage regresses.',
  ...
  // ── L3 — Measured / Enforced ────────────────────────────────────
  {
    ...
    details: 'PR acceptance tracking measures what percentage of AI-generated PRs are merged vs. rejected over time. A declining rate means the instructions need updating.',
  ...
  },
  {
    ...
    details: 'A PR review rubric lists the specific quality criteria reviewers (human or AI) should check: error handling, test coverage, naming conventions, security patterns.',
  ...
  },
  {
    ...
    details: 'A quality dashboard renders PR acceptance rates, coverage trends, review turnaround, test pass rates in one place.',
  ...
  // ── L4 — Adaptive / Structured ──────────────────────────────────
  {
    ...
    details: 'An auto-QA tuning config adjusts review strictness and prompt templates based on your L3 metrics — tightening coverage requirements when acceptance rate is high, relaxing style checks when they generate too many false positives.',
  ...
  },
  {
    ...
    details: 'A nightly compliance scan runs your full test suite, linters, and security checks on a cron schedule, catching regressions that slip through PR-level checks.',
  ...
  },
  {
    ...
    details: 'Takes AI-generated review comments and applies the suggested fixes directly as commits on the PR branch.',
  ...
  },
  {
    ...
    details: 'Uses AI or pattern-matching rules to classify new issues with labels the moment they are filed.',
  ...
  },
  {
    ...
    details: 'Watches for a specific label on issues and automatically dispatches an AI agent to attempt a fix, create a branch, and open a PR.',
  ...
  },
  {
    ...
    details: 'Classifies PRs by risk tier (T1-trivial, T2-standard, T3-critical). Low-risk changes fast-tracked, high-risk changes require senior review.',
  ...
  },
  {
    ...
    details: 'Defines hard boundaries for AI agents: files they must never modify, secrets they must never access, destructive operations they must never run.',
  ...
  },
  {
    ...
    details: 'An API or web page that exposes ACMM level, coverage stats, and CI pass rates as JSON or a web page.',
  ...
  },
  {
    ...
    details: 'Governance rules are written as executable code using OPA or ConfTest. The system enforces them automatically on every PR.',
  ...
  },
  {
    ...
    details: 'A committed file or directory where AI agents record what they learned during a session — patterns that worked, mistakes corrected, conventions that were unclear.',
  ...
  // ── L6 — Autonomous ─────────────────────────────────────────────
  {
    ...
    details: 'A cron-triggered workflow that scans the codebase for TODOs, stale dependencies, failing tests, or coverage gaps and files GitHub issues for each finding.',
  ...
  },
  {
    ...
    details: 'A dispatcher script or workflow coordinates multiple AI agents working on different parts of one task — one agent fixes the bug while another writes the test and a third updates the docs.',
  ...
  },
  {
    ...
    details: 'GitHub merge queue enabled with required CI checks and coverage gates. PRs that pass all checks auto-merge without human action.',
  ...
  },
  {
    ...
    details: 'A dashboard showing: active AI agents, PRs in review, issues auto-triaged today, nightly compliance, coverage trend.',
