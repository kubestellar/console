...
const CRITERIA: Criterion[] = [
  ...
  },
  {
    ...
    description: 'A CI/CD pipeline that automatically builds, tests, and gates every PR before merge.',
    rationale: 'The second fullsend readiness prerequisite — a repo without automated CI gates cannot safely trust agent changes.',
    details: 'An automated CI/CD pipeline is a set of workflows that builds, tests, and blocks merges when required checks fail. This is more mature than simply having CI configured: the pipeline actively enforces quality gates so AI-generated changes cannot slip through unchecked. An AI mission will create a CI workflow for your project\'s language and framework and wire it into pull request status checks.',
