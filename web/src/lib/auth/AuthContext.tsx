// Auth context + provider extracted from ../auth.tsx as part of the
// auth.tsx file split (#22976, part of #22962). No behaviour change —
// this is the same AuthContext/AuthProvider implementation that
