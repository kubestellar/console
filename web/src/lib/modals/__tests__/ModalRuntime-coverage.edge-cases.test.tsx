...
/**
 * Coverage tests for ModalRuntime.tsx — edge cases: table, key-value linkTo,
 * badges with missing data, parseModalYAML, no tabs, custom section without content.
 * Split from ModalRuntime-coverage.test.tsx (was 857 lines).
 */
