...
describe('KubectlProxy — getClusterUsage exception branch', () => {
...
describe('KubectlProxy — getClusterHealth usage timeout', () => {
...
describe('KubectlProxy — getNodes fallback error', () => {
...
describe('KubectlProxy — getPodMetrics error branches', () => {
