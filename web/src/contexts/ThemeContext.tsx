 ...
 * Theme Context
 *
 * Category: global singleton config.
 * Owns the application-wide theme selection, persistence, and document styling.
 */
...
function createDefaultThemeContextValue(): ThemeContextValue {
...
const {
  ...
  useRequiredStateContext: useTheme,
} = createStateContext<ThemeContextValue>({
  name: 'Theme',
