...
/**
 * AlertsContext — storage and lifecycle tests (A12–A14)
 *
 * Covers: createAlert deduplication, quota-exceeded persistence failure,
 * and periodic evaluation interval.
 */
...
// ═══════════════════════════════════════════════════════════════════════════
// Tests — storage and lifecycle (A12–A14)
// ═══════════════════════════════════════════════════════════════════════════

describe('AlertsContext — storage and lifecycle (A12–A14)', () => {
