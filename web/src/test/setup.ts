...
// NOTE: vi.mock calls must live at the module's top level — vitest 5 rejects
// nested vi.mock calls (they were always hoisted above any runtime guard anyway,
// so wrapping them in `if (isBrowserEnvironment)` never actually scoped them).
